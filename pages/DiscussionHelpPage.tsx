...
interface DiscussionHelpPageProps {
  t: any; // Translation object
  subject: 'English' | 'Svenska';
}

function DiscussionHelpPage({ t, subject }: DiscussionHelpPageProps): React.ReactElement {
  ...
  const handleSendMessage = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.error("Failed to get response from chat:", error);
...
export default DiscussionHelpPage;